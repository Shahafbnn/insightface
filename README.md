...
The training data includes, but not limited to the cleaned MS1M, VGG2 and CASIA-Webface datasets, which were already packed in MXNet binary format. Please open the [dataset](recognition/_datasets_) page for detail.
